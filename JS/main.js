...
function prefixStyle(e) {
	...
	return _cache[e] ? _cache[e] : e in _style ? _cache[e] = e: (jQuery.each(n,
		function(n) {
...
function Carousel(e, t) {
	...
	this.run = function(e, t) {
		p = e,
		c = (e - 1) * f + 360,
		u.css("transform", "rotateY(-" + c + "deg)").one(support.transitionEnd,
			function() {
				t && t()
			})
	},
	...
	this.palyVideo = function(e) {
		...
		i.on("ended",
			function() {
				i[0].pause(),
				i.addClass("bounceOut").one(support.animationEnd,
					function() {
						i.remove(),
						e.complete()
					})
...
function PageB(e, t) {
	...
	function o() {
		var e = new Carousel(u, {
			imgUrls: ["img/carousel/1.png",
			 "img/carousel/2.png",
			  "img/carousel/3.png"],

			videoUrls: ["img/carousel/1.mp4",
			 "img/carousel/2.mp4",
			  "img/carousel/3.mp4"]
		});
		return e
	...
	d = {
		standUp: function() {
			...
			function() {
				...
				e.resolve()
			}.defer(f.girl.throwBook + f.girl.standUp),
			e
		},
		walk: function(e) {
			var t = $.Deferred();
		...
		hugWalk: function(e) {
			...
			f.girl.hugWalk, "linear",
			function() {
				c.addClass("walk-stop").removeClass("girl-weep"),
				e()
			})
		},
		hug: function() {
...
function changePage(e, t, n) {
	e.addClass(t).one(support.animationEnd,
		function() {
			n && n()
		})
}
...
function(e, t) {
	...
	function(e, t) {
		...
		function x(e) {
			var t = J,
			n = Ie[e];
			return n || (n = b(e, t), "none" !== n && n || (We = (We || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = We[0].contentDocument, t.write(), t.close(), n = b(e, t), We.detach()), Ie[e] = n),
			n
		}
		function w(e, t, n) {
			...
			n && ("" !== s || Z.contains(e.ownerDocument, e) || (s = Z.style(e, t)), Be.test(s) && Re.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o)),
			void 0 !== s ? s + "": s
		}
		function C(e, t) {
			return {
		...
		function E(e, t, n, r, i) {
			for (var o = n === (r ? "border": "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)"margin" === n && (s += Z.css(e, n + Ce[o], !0, i)),
				r ? ("content" === n && (s -= Z.css(e, "padding" + Ce[o], !0, i)), "margin" !== n && (s -= Z.css(e, "border" + Ce[o] + "Width", !0, i))) : (s += Z.css(e, "padding" + Ce[o], !0, i), "padding" !== n && (s += Z.css(e, "border" + Ce[o] + "Width", !0, i)));
			return s
		}
		function N(e, t, n) {
			var r = !0,
		...
		function S(e, t) {
			for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++) r = e[s],
				r.style && (o[s] = ve.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && Te(r) && (o[s] = ve.access(r, "olddisplay", x(r.nodeName)))) : (i = Te(r), "none" === n && i || ve.set(r, "olddisplay", i ? n: Z.css(r, "display"))));
			for (s = 0; a > s; s++) r = e[s],
	...
	function O(e, t, n) {
		...
		1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], c = Z.css(e, "display"), l = "none" === c ? ve.get(e, "olddisplay") || x(e.nodeName) : c, "inline" === l && "none" === Z.css(e, "float") && (p.display = "inline-block")),
...
Z.extend = Z.fn.extend = function() {
	...
	for ("boolean" == typeof s && (c = s, s = arguments[a] || {},
		...
		r = e[t],
	s !== r && (c && r && (Z.isPlainObject(r) || (i = Z.isArray(r))) ? (i ? (i = !1, o = n && Z.isArray(n) ? n: []) : o = n && Z.isPlainObject(n) ? n: {},
		s[t] = Z.extend(c, o, r)) : void 0 !== r && (s[t] = r));
	return s
},
Z.extend({
...
function y(e) {
	for (var t, n, r, i = e.length,
		o = C.relative[e[0].type], s = o || C.relative[" "], a = o ? 1 : 0, u = p(function(e) {
			return e === t
		},
		s, !0), c = p(function(e) {
			return ee(t, e) > -1
		...
		s, !0), l = [function(e, n, r) {
			...
			return t = null,
			i
		}]; i > a; a++) if (n = C.relative[e[a].type]) l = [p(h(l), n)];
		else {
		...
		ve = /^[^{]+\{\s*\[native \w/,
			...
			q = t.setDocument = function(e) {
				...
				P = [], $ = [], (w.qsa = ve.test(r.querySelectorAll)) && (i(function(e) {
					...
					e.querySelectorAll("[id~=" + W + "-]").length || $.push("~="),
					e.querySelectorAll(":checked").length || $.push(":checked"),
					e.querySelectorAll("a#" + W + "+*").length || $.push(".#.+[+~]")
				}), i(function(e) {
					...
					M.call(e, "[s!='']:x"),
					P.push("!=", se)
				}), $ = $.length && new RegExp($.join("|")), P = P.length && new RegExp(P.join("|")), t = ve.test(L.compareDocumentPosition), F = t || ve.test(L.contains) ?
				function(e, t) {
...
t.attr = function(e, t) { (e.ownerDocument || e) !== O && q(e);
		...
		CHILD: function(e, t, n, r, i) {
			...
			function(e) {
				...
				if (m) {
					...
					else for (; (f = ++p && f && f[g] || (d = p = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v: 1 !== f.nodeType) || !++d || (y && ((f[W] || (f[W] = {}))[e] = [R, d]), f !== t)););
					return d -= i,
					d === r || d % r === 0 && d / r >= 0
				}
			}
...
for (x in {
	...
	for (x in {
		...
		E = t.tokenize = function(e, n) {
			...
			for (a = e, u = [], c = C.preFilter; a;) { (!r || (i = ce.exec(a))) && (i && (a = a.slice(i[0].length) || a), u.push(o = [])),
				r = !1,
		...
		S = t.select = function(e, t, n, r) {
			...
			return (c || N(e, f))(r, t, !H, n, be.test(e) && l(t.parentNode) || t),
			n
		},
		w.sortStable = W.split("").sort(Y).join("") === W,
	...
	function(e, t) {
		Z.fn[e] = function(n, r) {
			...
			this.length > 1 && (de[e] || Z.unique(i), fe.test(e) && i.reverse()),
			this.pushStack(i)
		}
	});
	var pe = /\S+/g,
...
Z.event = {
	...
	add: function(e, t, n, r, i) {
		...
		}), t = (t || "").match(pe) || [""], c = t.length; c--;) a = De.exec(t[c]) || [],
			p = g = a[1],
			h = (a[2] || "").split(".").sort(),
			p && (f = Z.event.special[p] || {},
				p = (i ? f.delegateType: f.bindType) || p, f = Z.event.special[p] || {},
				l = Z.extend({
					type: p,
					origType: g,
					data: r,
			...
			if (m && (u = m.events)) {
				for (t = (t || "").match(pe) || [""], c = t.length; c--;) if (a = De.exec(t[c]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p) {
					for (f = Z.event.special[p] || {},
						p = (r ? f.delegateType: f.bindType) || p, d = u[p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;) l = d[o],
						!i && g !== l.origType || n && n.guid !== l.guid || a && !a.test(l.namespace) || r && r !== l.selector && ("**" !== r || !l.selector) || (d.splice(o, 1), l.selector && d.delegateCount--, f.remove && f.remove.call(e, l));
		...
		trigger: function(t, n, r, i) {
			...
			if (s = a = r = r || J, 3 !== r.nodeType && 8 !== r.nodeType && !Ae.test(p + Z.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), c = p.indexOf(":") < 0 && "on" + p, t = t[Z.expando] ? t: new Z.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : Z.makeArray(n, [t]), f = Z.event.special[p] || {},
				...
				if (!i && !f.noBubble && !Z.isWindow(r)) {
					for (u = f.delegateType || p, Ae.test(u + p) || (s = s.parentNode); s; s = s.parentNode) d.push(s),
						a = s;
					a === (r.ownerDocument || J) && d.push(a.defaultView || a.parentWindow || e)
				}
				for (o = 0; (s = d[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u: f.bindType || p,
					l = (ve.get(s, "events") || {})[t.type] && ve.get(s, "handle"),
				l && l.apply(s, n),
				l = c && s[c],
				l && l.apply && Z.acceptData(s) && (t.result = l.apply(s, n), t.result === !1 && t.preventDefault());
				return t.type = p,
				i || t.isDefaultPrevented() || f._default && f._default.apply(d.pop(), n) !== !1 || !Z.acceptData(r) || c && Z.isFunction(r[p]) && !Z.isWindow(r) && (a = r[c], a && (r[c] = null), Z.event.triggered = p, r[p](), Z.event.triggered = void 0, a && (r[c] = a)),
				t.result
			}
		},
		dispatch: function(e) {
		...
		fix: function(e) {
			...
			o = e,
			s = this.fixHooks[i];
			for (s || (this.fixHooks[i] = s = Se.test(i) ? this.mouseHooks: Ne.test(i) ? this.keyHooks: {}), r = s.props ? this.props.concat(s.props) : this.props, e = new Z.Event(o), t = r.length; t--;) n = r[t],
				e[n] = o[n];
	...
	Z.extend({
		...
		buildFragment: function(e, t, n, r) {
			for (var i, o, s, a, u, c, l = t.createDocumentFragment(), f = [], d = 0, p = e.length; p > d; d++) if (i = e[d], i || 0 === i) if ("object" === Z.type(i)) Z.merge(f, i.nodeType ? [i] : i);
				else if (Oe.test(i)) {
	...
	Z.extend({
		...
		style: function(e, t, n, r) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				...
				u = e.style;
				return t = Z.cssProps[a] || (Z.cssProps[a] = T(u, a)),
				s = Z.cssHooks[t] || Z.cssHooks[a],
				void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i: u[t] : (o = typeof n, "string" === o && (i = Ye.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || Z.cssNumber[a] || (n += "px"), G.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u[t] = n)), void 0)
			}
		},
	...
	Z.each(["height", "width"],
		function(e, t) {
			Z.cssHooks[t] = {
				get: function(e, n, r) {
					return n ? ze.test(Z.css(e, "display")) && 0 === e.offsetWidth ? Z.swap(e, Ue,
						function() {
							return N(e, t, r)
						}) : N(e, t, r) : void 0
				},
...
Z.fx.tick = function() {
	var e, t = 0,
	n = Z.timers;
	for (Ge = Z.now(); t < n.length; t++) e = n[t],
		...
		select: {
			get: function(e) {
				for (var t, n, r = e.options,
					...
					s = o ? null: [], a = o ? i + 1 : r.length, u = 0 > i ? a: o ? i: 0; a > u; u++) if (n = r[u], (n.selected || u === i) && (G.optDisabled ? !n.disabled: null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !Z.nodeName(n.parentNode, "optgroup"))) {
...
Z.extend({
	...
	ajax: function(e, t) {
		...
		t = t || {};
		var r, i, o, s, a, u, c, l, f = Z.ajaxSetup({},
			t),
		d = f.context || f,
	...
	offset: function(e) {
		if (arguments.length) return void 0 === e ? this: this.each(function(t) {
			...
			if (o) return t = o.documentElement,
				Z.contains(t, r) ? (typeof r.getBoundingClientRect !== Ee && (i = r.getBoundingClientRect()), n = R(o), {
...
function(e, t) {
	...
	function n() {
		return f.style[d.transform] = "",
		f.style[d.transform] = "rotateY(90deg)",
		"" !== f.style[d.transform]
	}
	function r(e) {
	...
	e.cssHooks["transit:transform"] = {
		...
		set: function(t, n) {
			...
			"WebkitTransform" !== d.transform || p ? t.style[d.transform] = i.toString() : t.style[d.transform] = i.toString(!0),
	...
	e.fn.transition = e.fn.transit = function(t, n, r, o) {
		...
		"object" == typeof n && (r = n.easing, u = n.delay || 0, c = "undefined" == typeof n.queue ? !0 : n.queue, o = n.complete, n = n.duration),
		"function" == typeof r && (o = r, r = void 0),
		"undefined" != typeof f.easing && (r = f.easing, delete f.easing),
		"undefined" != typeof f.duration && (n = f.duration, delete f.duration),
		"undefined" != typeof f.complete && (o = f.complete, delete f.complete),
		"undefined" != typeof f.queue && (c = f.queue, delete f.queue),
		"undefined" != typeof f.delay && (u = f.delay, delete f.delay),
		...
		b = function(t) {
			...
			m > 0 && g && e.transit.useTransitionEnd ? (n = !0, a.bind(g, r)) : window.setTimeout(r, m),
			a.each(function() {
				m > 0 && (this.style[d.transition] = p),
				e(this).css(f)
			})
		},
		x = function(e) {
...
var Observer = function(e) {
	...
	return function() {
		return this.on = this.subscribe = t,
		this.off = this.unsubscribe = r,
		this.trigger = this.publish = i,
		this.one = n,
		this
	}
} ([].slice),
...
Function.prototype.createDelegate = function(e, t, n) {
	...
	return function() {
		var i = t || arguments;
		if (n === !0) i = Array.prototype.slice.call(arguments, 0),
			i = i.concat(t);
		else if (isNumber(n)) {
...
function t(e, t, r) {
	...
	function n(e) {
		this.snowSettings = e,
		this.radius = r(e.minRadius, e.maxRadius),
		this.initialX = Math.random() * e.maxX,
		this.y = -(500 * Math.random()),
		this.speedY = r(e.minSpeedY, e.maxSpeedY),
		this.speedX = e.speedX,
		this.alpha = r(e.minAlpha, e.maxAlpha),
		this.angle = Math.random(2 * Math.PI),
		this.x = this.initialX + Math.sin(this.angle),
		this.moveX = r(e.minMoveX, e.maxMoveX)
	}
	function r(e, t) {
	...
	n.prototype.render = function(e) {
		e.beginPath(),
		e.fillStyle = "rgba(255, 255, 255, " + this.alpha + ")",
		e.arc(this.x, this.y, this.radius, 0, 2 * Math.PI, !0),
		e.closePath(),
		e.fill()
	},
	n.prototype.update = function() {
		this.y += this.speedY,
		this.y > this.snowSettings.maxY && (this.y -= this.snowSettings.maxY),
...
PageA.prototype.openWindow = function(e) {
	...
	r = function(e) {
		e.one(support.transitionEnd,
			function(t) {
				e.removeClass("window-transition"),
				n()
			})
	};
	r(this.$leftWin.addClass("window-transition").addClass("hover")),
	r(this.$rightWin.addClass("window-transition").addClass("hover"))
},
...
PageA.prototype.next = function(e) {
	var t = $.Deferred();
	return this.$boy.transition(e.style, e.time, "linear",
		function() {
			t.resolve()
		}),
	t
...
PageA.prototype.run = function(e) {
	...
	n({
		...
		t.stopWalk(),
		function() {
			t.openWindow(function() { (function() {
				e()
			}).defer(1e3)
		})
		}.defer(1e3)
...
PageC.prototype.closeWindow = function(e) {
	...
	r = function(e) {
		e.addClass("close").one("animationend webkitAnimationEnd",
			function(e) {
				n()
			})
	};
...
PageC.prototype.next = function(e) {
	var t = $.Deferred();
	return this.$deer.transition(e.style, e.time, "linear",
		function() {
			t.resolve()
		}),
	t
...
var Christmas = function() {
	...
	n = $(".page-b"),
	r = $(".page-c"),
	i = Hmlt5Audio("music/one.mp3");
	i.end(function() {
		Hmlt5Audio("music/two.mp3", !0)
	});
	var o = new PageA(t);
	o.run(function() {
		e.publish("completeA")
	...
	e.subscribe("completeA",
		function() {
			changePage(t, "effect-out",
				function() {
					e.publish("pageB")
				})
		}),
	e.subscribe("completeB",
		function() {
			changePage(r, "effect-in",
				function() {
					e.publish("pageC")
				})
		})
